...
-- Сортировка по убыванию в поле salary
SELECT
	*
FROM staff
ORDER BY salary DESC; 

-- Сортировка по возрастанию в поле salary
SELECT
	*
FROM staff
ORDER BY salary; 
...
SELECT 
	COUNT(DISTINCT seniority) AS count_post
FROM staff;


-- Выведите специальности, у которых средний возраст сотрудников меньше 30 лет

-- Сосчитаем сначала средний возраст внтури каждой специальности
SELECT 
	post,
	avg(age) as avg_age
FROM staff
